...
public class TextMeshLoader {
	...
	public static final double LINE_HEIGHT = 0.05f;
	public static final int SPACE_ASCII = 32;
	
	private MetaData metaData;
	
	public TextMeshLoader(File file)
	{
		metaData = new MetaData(file);
	}
	
	public TextMeshData createMesh(GUIText text)
	{
    ...
    private TextMeshData createQuadVertices(GUIText text, List<Line> lines) {
        ...
        return new TextMeshData(Utils.floatListToArray(vertices), Utils.floatListToArray(textureCoords));
    }
