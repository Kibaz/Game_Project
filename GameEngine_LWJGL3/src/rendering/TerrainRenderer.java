...
public class TerrainRenderer {
	...
	public TerrainRenderer(TerrainShader shader, Matrix4f projectionMatrix)
	{
		...
		shader.loadCausticTexture();
		shader.loadShadowMapSize(ShadowRenderer.MAP_SIZE);
	...
	public void render(List<Terrain> terrains, Matrix4f toShadowSpace)
	{
		...
		for(Terrain terrain:terrains)
		{
			...
			GL11.glDrawElements(GL11.GL_TRIANGLES, terrain.getBaseModel().getVertCount(), GL11.GL_UNSIGNED_INT, 0);
			unbindTexturedModel();
		}
	}
	...
	{
		BaseModel baseModel = terrain.getBaseModel();
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, terrain.getCausticTexture().getID());
	}
